...
func (js *QuickJS) wrapFunc(funcName string, helper *elutils.EmbeddingFuncHelper) elutils.FnGoFunc {
...
func (js *QuickJS) call(goal string) (res interface{}, err error) {
